...
Wait - Isn't the coin win effect the same everywhere?

There should not be multiple options.

I don't think that anything
in the game reflects these
different asset images
...
class WinEffectForEachAmmoType extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return context.watch<GamePlayVariableDataProvider>().currentAmmunition ==
            AmmoType.orange
        ? context.watch<SettingsDataProvider>().activatedExplodingAmmo == false
            ? Container(
                height: 40.0,
                width: 40.0,
        ...
        : context.watch<GamePlayVariableDataProvider>().currentAmmunition ==
                AmmoType.yellow
            ? context.watch<SettingsDataProvider>().activatedExplodingAmmo ==
                    false
                ? Container(
                    height: 40.0,
                    width: 40.0,
